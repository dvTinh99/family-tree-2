...
<template>
  <div
    class="group relative w-[180px] rounded-2xl bg-white border border-gray-200 shadow-sm transition-all duration-200 ease-out hover:shadow-md"
    :class="selected ? 'ring-2 ring-indigo-500' : ''"
  >
    <!-- Avatar -->
    <div class="flex justify-center pt-4">
      <div class="h-12 w-12 rounded-full bg-gray-100 ring-2" :class="genderClass">
        <img
          v-if="data.avatar"
          :src="data.avatar"
    ...
    <div
      class="absolute inset-x-0 bottom-2 flex justify-center gap-2 opacity-0 group-hover:opacity-100 transition-opacity"
    >
      <button
